...
document.getElementById("btnSi").addEventListener("click", function () {
  Swal.fire({
    position: "top-center",
    title: "Sou o menino mais feliz do mundo🥰",
    showConfirmButton: false,
    timer: 1500,
  });

  var parrafo = document.querySelector("#cuadroDialogo p");
  parrafo.textContent = "🎉🎈 Parabéns, meu amor! Mesmo distantes, meu carinho por você é imenso. Que seu dia seja cheio de alegria e que logo possamos comemorar juntos. 🥳🎂💖";
